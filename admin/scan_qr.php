<?php
    ...
    // Get idno
    $sql = "SELECT max(locker_id) as locker_id from tbl_locker_data";
                                ...
                                <div class="row" style="min-height: 70vh">
                                    <div style="margin: 0 auto; width:500px;">
                                        <form type='post' class="form-group mt-3" style="display: flex; flex-direction: column; width: 100%; justify-content: center;">
                                            <label for="colFormLabel"  style="text-align: center;">Search ID Locker</label>
                                        ...
                                        <?php
                                            $dataas = $_GET['scan'];
                                            $a= "  SELECT * FROM [SERE].[dbo].[tbl_locker_data] where locker_id='$dataas'";
                                                // echo $a;
