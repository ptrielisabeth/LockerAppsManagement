                                        ...
                                        <form role="form" id="saveinput" class="form-horizontal" action="add_observation.php" method="post" enctype="multipart/form-data">
                                            <div class="modal-body">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="date" class="form-control" name="date_observation" id="date_observation"
                                                            value="<?php echo $getType['date_observation']; ?>" placeholder="Input Date">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="locker_id" class="form-control" name="locker_id" id="locker_id"
                                                            value="<?php echo $getType['locker_id']; ?>" placeholder="Input Locker ID">
                                                    </div>
                                                </div>
