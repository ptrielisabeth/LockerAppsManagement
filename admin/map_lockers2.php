              ...
              <div class="col-md-12">
                <div class="card card-outline">
                        ...
                        <div class="col-md-12">
                          <center>
                            <div style="width: 70%; padding-top: 0%;">
                              <h3 style="text-align: center;">Map Locker</h3>
                            </div>
                          </center>
                        </div>
                      </div>
                  ...
                  <div class="card-header bg-info">
                    ...
                    <div class="col-md-2">
                        <label>Locker Kosong</label>
                        <h2>
                          <?php $locker1 = sqlsrv_query($conn,"select COUNT(*) as locker1 FROM [SERE].[dbo].[tbl_locker_data] where name = ''"); ?>
                          <?php while($locker3 = sqlsrv_fetch_array($locker1)){ echo $locker3['locker1']; } ?>
                        </h2>
                    </div><br>
...
<script>
  ...
  function filterByStatus() {
    ...
    $.ajax({
      ...
      url: 'filteraction_map_locker2.php',
