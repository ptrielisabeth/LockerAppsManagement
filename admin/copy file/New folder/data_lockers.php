            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card card-outline">
                  ...
                  <!-- The Hasil Print-->
                  <div class="modal fade" id="HasilPrint" tabindex="-1" role="dialog"
                            aria-labelledby="memberModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-bg">
                                <div class="modal-content">
                                    <div class="modal-header box-solid bg-green">
                                    <h4 class="modal-title" id="memberModalLabel">QR Code Locker</h4>
                                        <button type="button" class="close" data-dismiss="modal"><span
                                                aria-hidden="true">&times;</span><span
                                                class="sr-only">Close</span></button>     
                                    </div>
                                        ...
                                        <form role="form" id="saveinput" class="form-horizontal" action="add_locker.php" method="post">
                                            <div class="modal-body">
                                                ...
                                                <?php 
                                                  ...
                                                  echo "<img src='".$qrcode."' width='250' height='250'>";
                                                ?>
                        ...
                        <tr>
                            ...
                            <td>
                              <?php 
                                ...
                                QRcode::png($r['locker_id'] . ' | ' . $r['name'] . ' | ' . $r['talent_id'] . ' | ' . $r['gender'] . ' | ' . $r['plant'] . ' | ' . $r['area'] . ' | ' . $r['dept'], $qrcode, 'M');
                                echo "<img src='".$qrcode."' width='145' height='145'>";
                              ?>
                            </td>
                            <td>
                              <button onchange="filterByStatus()" method="post" data0='<?= $r['locker_id'] ?>' onclick="showQRCode($(this).attr('data0'))" class="btn btn-success"><i class="fa fa-print"></i>Print</button>
