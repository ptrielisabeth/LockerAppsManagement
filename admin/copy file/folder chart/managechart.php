              ...
              <div class="col-md-12">
                <div class="card card-outline">
                        ...
                        <div class="col-md-12">
                          <center>
                            <div style="width: 70%; padding-top: 0%;">
                              <h3 style="text-align: center;"><strong>Manage Chart</strong></h3>
                            </div>
                          </center>
                        </div>
                      </div>               
                  ...
                  <div class="card-header bg-info">
                    <div class="row">
                      <div class="row">
                      <div class="text-left" style="width: 80px; margin-top: 8px; margin-left: 5px;">
                        <button data-toggle="modal" data-target="#ModalAdd" class="btn btn-light"><i class="fa fa-plus"></i>&nbspAdd New</button>
                      </div>
                      <div class="text-left" style="width: 80px; margin-top: 8px; margin-left: 30px;">
                        <a href="chart.php"><button data-toggle="modal"  class="btn btn-warning"><i class="fa fa-caret-left"></i>&nbspBack</button></a>        
                      </div> 
                    </div>
...
<script>
 function filterByStatus() {
    ...
    $.ajax({
      ...
      url: 'filteraction_manage_chart.php',
