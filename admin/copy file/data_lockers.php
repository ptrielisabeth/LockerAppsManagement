                  ...
                  <div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-bg">
                                <div class="modal-content">
                                    ...
                                    <div class="box-body">
                                        <form role="form" id="saveinput" class="form-horizontal" action="add_rate.php" method="post">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="date" class="form-control" name="start_date" id="start_date"
                                                            value="<?php echo $getType['start_date']; ?>" required>
                                                    </div>
                                                </div>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a class="btn btn-sm btn-success text-white"
                              href="actionsum_detail.php?id=<?php echo $r['insp_head_id']; ?>"><i
                                class='fa fa-edit'></i>
                              Detail</a>
