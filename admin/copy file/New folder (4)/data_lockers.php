                ...
                <div class="card card-outline">
                  ...
                  <div class="card-header bg-info">
                    <div class="row">
                      ...
                      <div class="row">
                      <div class="text-left" style="width: 90px; margin-top: 32px; margin-left: 10px;">
                        <button data-toggle="modal" data-target="#ModalAdd" class="btn btn-light"><i class="fa fa-plus"></i> Add New Locker</button>           
                      </div> 
                      <div class="text-left" style="width: 130px; margin-top: 32px; margin-left: 70px;">
                        <form target="_blank" method="post" action="printall_qr.php">
                          ...
                          <button class="btn btn-success"><i class="fa fa-print"></i> Print All QR Code</button>
                        </form>           
                      </div> 
                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="sesa" class="form-control" name="talent_id" id="talent_id"
                                                            value="<?php echo $getType['talent_id']; ?>" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="number" class="form-control" name="no_phone" id="no_phone"
                                                            value="<?php echo $getType['no_phone']; ?>" >
                                                    </div>
                                                </div>
                            ...
                            <button type="button" class="close" data-dismiss="modal"><span
                              ...
                              <div class="modal-content">
                                    <div class="modal-body" id="info_update" >
                                        ...
                                        <div class="modal-footer">
                                          <button type="submit" data-dismiss="modal" id="update" class="btn btn-success" onclick="updateUser($('#locker_id1').val(), $('#name1').val(), $('#talent_id1').val(), $('#gender1').val(), $('#plant2').val(), $('#area2').val(), $('#floor2').val(), $('#dept2').val(), $('#no_phone1').val())"> Save</button>
