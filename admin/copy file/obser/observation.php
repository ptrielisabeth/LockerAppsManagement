              ...
              <div class="col-md-12">
                <div class="card card-outline">
                  ...
                  <div class="card-header bg-info">
                    <div class="row">
                      <div class="row">
                      <div class="text-left" style="width: 165px; margin-top: 8px; margin-left: 5px;">
                        <button data-toggle="modal" data-target="#ModalAdd" class="btn btn-light"><i class="fa fa-plus"></i>&nbspAdd Observation</button>           
                      </div> 
                      <div class="text-left" style="width: 80px; margin-top: 8px; margin-left: 0px;">
                        <a onclick="download_locker('<?php echo $plant ?>')"><button data-toggle="modal" class="btn btn-danger"><i class="fa fa-download"></i>&nbspDownload CSV</button></a>           
                      </div> 
                    </div>
                ...
                <div class="card-body">
                  ...
                  <div class="modal fade" id="ModalEdit"<?php echo $data['obserID']; ?> tabindex="-1" role="dialog" aria-labelledby="memberModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-bg">
                        <div class="modal-header box-solid bg-green">
                            <h4 class="modal-title" id="memberModalLabel">Edit Observation</h4>
                            <button type="button" class="close" data-dismiss="modal"><span
                                    aria-hidden="true">&times;</span><span
                                    class="sr-only">Close</span></button>
                            </div>
                              <div class="modal-content">
                                    <div class="modal-body" id="info_update" >
                                        ...
                                        <div class="form-group row">
                                          <label class="col-sm-4 col-form-label">Description : </label>
                                          <div class="col-sm-8">
                                              <input disabled type="text" step="1" class="form-control" name="description" id="description1" value=""  />
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                          <label class="col-sm-4 col-form-label">Location : </label>
                                          <div class="col-sm-8">
                                              <input disabled type="text" step="1" class="form-control" name="location" id="location1" value=""  />
                                          </div>
                                        </div>


                                        <div class="modal-footer">
                                          <button type="submit" data-dismiss="modal" id="update" class="btn btn-success" onclick="updateUser($('#obserID1').val(), $('#description1').val(), $('#plant1').val(), $('#floor1').val(), $('#location1').val(), $('#img1').val(), $('#status1').val())"> Save</button>
...
<script>
  function updateUser(description1, plant1, floor1, location1, status1, img1){
    console.log(plant1);
        $.ajax({
            type: "POST",
