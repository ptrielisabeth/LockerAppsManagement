            ...
            <div class="box" style="width:100%">
                ...
                <div class="row" id="tbl_priority">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-1">
                    <?php
                        $qry3 = sqlsrv_query($conn, "select * from [SERE].[dbo].[tbl_locker] where locker_id='A007' or locker_id='A008' or locker_id='A009' or locker_id='A010' or locker_id='A011' or locker_id='A012'", array(), array("Scrollable"=>SQLSRV_CURSOR_KEYSET));
                        while($c=sqlsrv_fetch_array($qry3)){
                          $kol = $c['locker_id'];
                          $kol1 = $c['talent_id'];
                          $kol2 = $c['plant']; 
                      ...
                      <div style='margin-bottom: 10px;'>
                        ...
                        <div class="<?php if($kol1 != '-' && $kol2 != '-' && $kol3 != '-' && $kol1 != NULL && $kol2 != NULL && $kol3 != NULL){ echo 'bg-success';} else { echo 'bg-danger';} ?> text-center text-bold" width="100vw"><?php echo $kol ?> (<?php echo $kol2 ?>)</div>
                      </div>
                      <?php
                        }
                      ?>
