                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline">
                            <div class="card-header bg-success">
                                ...
                                <div style="text-align: center;"> <h3><strong>Locker Management</strong></h3></div> 
                            </div>
                            </li>
                                ...
                                <div class="row" style="min-height: 83vh">
                                    <div style="margin: 0 auto; width:500px;">
                                        <form type='post' class="form-group mt-3" style="display: flex; flex-direction: column; width: 100%; justify-content: center;">
                                            <label for="colFormLabel"  style="text-align: center;">Data Locker</label>
                                            <input type="text" class="form-control timepicker" id="scan" name='scan' placeholder="Locker ID...">
                                            <button class='btn btn-primary btn-sm mt-2 mb-4'>Search</button>
                                        </form>
                                        <?php
                                            $dataas = $_GET['scan'];
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div>
                                                    <td>
                                                        <a class="left" id="<?php echo $data['locker_id']; ?>" >
                                                                <img  class='postentry' src="imgprofile/<?= $r['img'] ?>" width="160px" height=" 200px" />
                                                        </a>
                                                    </td>
                                            </div>
                                        </div>
