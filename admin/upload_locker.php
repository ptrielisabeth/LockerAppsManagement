...
if (isset($_FILES["image"])) {
	...
	if($upload) {
		...
		for ($row=2; $row<=$rows; $row++) {
			...
			$qry = sqlsrv_query($conn, "INSERT INTO tbl_locker_data (locker_id, talent_id, plant, area, floor, dept, name, gender, no_phone) VALUES ('".$locker_id."', '".$talent_id."', '".$plant."', '".$area."', '".$floor."', '".$dept."', '".$name."', '".$gender."', '".$no_phone."')");
